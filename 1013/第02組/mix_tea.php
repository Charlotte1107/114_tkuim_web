...
<body>
  ...
  <form action="" method="post">
    <div class="tea-grid">
      <div class="tea-item">
        <img src="夏暮青柚.jpg" width="150"><br>
        夏暮青柚 - NT$65<br>
        數量：<input type="number" name="qty[夏暮青柚]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="桑檸熟紅.jpg" width="150"><br>
        桑檸熟紅 - NT$55<br>
        數量：<input type="number" name="qty[桑檸熟紅]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="胭脂多多.jpg" width="150"><br>
        胭脂多多 - NT$50<br>
        數量：<input type="number" name="qty[胭脂多多]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="莓果綠茶.jpg" width="150"><br>
        莓果綠茶 - NT$70<br>
        數量：<input type="number" name="qty[莓果綠茶]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="蜜橙熟紅.jpg" width="150"><br>
        蜜橙熟紅 - NT$55<br>
        數量：<input type="number" name="qty[蜜橙熟紅]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="金蜜檸果.jpg" width="150"><br>
        金蜜檸果 - NT$60<br>
        數量：<input type="number" name="qty[金蜜檸果]" value="0" min="0"><br>
      </div>
    </div>
    <br>
    冰度：
