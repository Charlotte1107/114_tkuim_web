...
<body>
  ...
  <form action="" method="post">
    <div class="tea-grid">
      <div class="tea-item">
        <img src="雲蓋可可.jpg" width="150"><br>
        雲蓋可可 - NT$80<br>
        數量：<input type="number" name="qty[雲蓋可可]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="雲蓋青茶.jpg" width="150"><br>
        雲蓋青茶 - NT$75<br>
        數量：<input type="number" name="qty[雲蓋青茶]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="雲蓋紅玉.jpg" width="150"><br>
        雲蓋紅玉 - NT$75<br>
        數量：<input type="number" name="qty[雲蓋紅玉]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="雲蓋莓果.jpg" width="150"><br>
        雲蓋莓果 - NT$85<br>
        數量：<input type="number" name="qty[雲蓋莓果]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="雲蓋歐蕾.jpg" width="150"><br>
        雲蓋歐蕾 - NT$85<br>
        數量：<input type="number" name="qty[雲蓋歐蕾]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="雲蓋烏龍.jpg" width="150"><br>
        雲蓋烏龍 - NT$70<br>
        數量：<input type="number" name="qty[雲蓋烏龍]" value="0" min="0"><br>
      </div>
    </div>
    <br>
    冰度：
    ...
    加料：
    <select name="add[]" multiple size='4'>
