...
<body>
  ...
  <form action="" method="post">
    <div class="tea-grid">
      <div class="tea-item">
        <img src="暮色紅玉.jpg" width="150"><br>
        暮色紅玉 - NT$60<br>
        數量：<input type="number" name="qty[暮色紅玉]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="焙影烏龍.jpg" width="150"><br>
        焙影烏龍 - NT$65<br>
        數量：<input type="number" name="qty[焙影烏龍]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="蜜香琥珀.jpg" width="150"><br>
        蜜香琥珀 - NT$55<br>
        數量：<input type="number" name="qty[蜜香琥珀]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="穀雨春芽.jpg" width="150"><br>
        穀雨春芽 - NT$70<br>
        數量：<input type="number" name="qty[穀雨春芽]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="霧嵐青茶.jpg" width="150"><br>
        霧嵐青茶 - NT$50<br>
        數量：<input type="number" name="qty[霧嵐青茶]" value="0" min="0"><br>
      </div>
      <div class="tea-item">
        <img src="白毫雪露.jpg" width="150"><br>
        白毫雪露 - NT$60<br>
        數量：<input type="number" name="qty[白毫雪露]" value="0" min="0"><br>
      </div>
    </div>
    <br>
    冰度：
